...
namespace Powerr.Editor
{
    ...
    static class CICDPipeline
    {
        ...
        static Dictionary<string, string> GetValidatedOptions()
        {
            ...
            if (!validatedOptions.TryGetValue("standaloneBuildSubtarget", out string standaloneBuildSubtarget) || !Enum.IsDefined(typeof(StandaloneBuildSubtarget), standaloneBuildSubtarget))
            {
                const string defaultStandaloneBuildSubtarget = "NoSubtarget";
                Console.WriteLine($"Missing or invalid argument -standaloneBuildSubtarget, defaulting to {defaultStandaloneBuildSubtarget}.");
                validatedOptions.Add("standaloneBuildSubtarget", defaultStandaloneBuildSubtarget);
            }
        ...
        static void BuildProject()
        {
            ...
            BuildPlayerOptions buildOptions = new BuildPlayerOptions
            {
                ...
                subtarget = (int)Enum.Parse(typeof(StandaloneBuildSubtarget), options["standaloneBuildSubtarget"])
            };
